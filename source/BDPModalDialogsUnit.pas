...
begin
  ...
  fTexture.ARGBImage.Bar(0,0,3,fTexture.ARGBImage.Height,OverlayPalette[2]);
  fTexture.ARGBImage.Bar(fTexture.ARGBImage.Width-3,0,3,fTexture.ARGBImage.Height,OverlayPalette[2]);
  fTexture.ARGBImage.Bar(0,fTexture.ARGBImage.Height-3,fTexture.ARGBImage.Width,3,OverlayPalette[2]);
